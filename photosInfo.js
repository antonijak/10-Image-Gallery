const photosInfo = [{
    ...
    skills: ['HTML5', 'CSS3', 'Javascript', 'React.js', 'Redux', 'Node.js', 'MangoDB'],
  ...
  },
  {
    ...
    longTermVision: 'Be able to develop well-know program',
    motivatesMe: 'Problem solving',
    favoriteQuote: 'A good programmer looks both ways when crossing a one way street',
  ...
  {
    firstName: 'Asabeneh The Teacher',
    lastName: '',
    title: 'Teacher',
    nationality: '',
    src: 'asabeneh.jpg',
